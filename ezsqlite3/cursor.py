...
class Cursor:
    ...
    async def _execute(self, fn, *args, **kwargs):
        """Execute the given on the shared connection's thread"""
    ...
    def rowcount(self) -> int:
        """The number of rows modified by the last query."""
        return self._cursor.rowcount

    @property
    def lastrowid(self) -> int:
        """The last rowid modified by the last query."""
    ...
    def description(self) -> Tuple[Tuple[str, None, None, None, None, None, None], ...]:
        """The description of the result set."""
